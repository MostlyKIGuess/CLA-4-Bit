...
HD_PWD='C:/Users/Krish/Desktop/College/VLSI/CLA-4-Bit/verilog/CLA/CLA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cla_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cla_tb.tcl

...
HD_PWD='C:/Users/Krish/Desktop/College/VLSI/CLA-4-Bit/verilog/CLA/CLA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cla_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cla_tb.tcl -notrace

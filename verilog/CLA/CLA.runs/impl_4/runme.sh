...
HD_PWD='C:/Users/Krish/Desktop/College/VLSI/CLA-4-Bit/verilog/CLA/CLA.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log fullcircuitwithdff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fullcircuitwithdff.tcl -notrace
